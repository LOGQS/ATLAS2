...
interface EnhancedCreationViewerProps {
  ...
  onOpenEditModal: (creation: Creation) => void;
}
...
const EnhancedCreationViewer: React.FC<EnhancedCreationViewerProps> = ({
  ...
  // Handle editing of a creation
  const handleEditCreation = (e: React.MouseEvent, creation: Creation) => {
    e.stopPropagation();
    if (!creation.id) return;

    onOpenEditModal(creation);
  };
      ...
      >
        ...
        {!isSelectMode && (
          <div className="creation-item-actions">
            ...
            <button
              className="creation-item-edit"
              onClick={(e) => handleEditCreation(e, creation)}
              title="Edit creation content"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8"></path>
